...
private _group1 = [_spawnpos, WEST, (configFile >> "CfgGroups" >> OT_side_NATO >> OT_faction_NATO >> "Infantry" >> _squadtype)] call BIS_fnc_spawnGroup;
...
if !(_byair) then {
	...
	_group2 = [_spawnpos, WEST, (configFile >> "CfgGroups" >> OT_side_NATO >> OT_faction_NATO >> "Infantry" >> _squadtype)] call BIS_fnc_spawnGroup;
